  ...
  return (
    <footer className="page-footer">
        ...
        <div className="row">
          ...
          <div className="col l4 offset-l2 s12">
            ...
            <ul>
              ...
              <li><Link onClick={()=> openInNewTab("https://github.com/OpalSnellneberger")}  className="grey-text text-lighten-3 footerLink" href="#!">Opal Snellenberger - Back End</Link></li>
            </ul>
          </div>
        </div>
      </div>
      <div className="footer-copyright">
        <div className="container">
          © 2024 Copyright
          <Link onClick={()=> openInNewTab("https://github.com/mathilde-01/pixel-paws")} className="grey-text text-lighten-4 right footerLink" href="#!" >Pixel Pals GitHub</Link>
        </div>
      </div>
    </footer>
  )
